...
description: Szczegółowa konfiguracja per platforma — Claude Desktop, Claude Code, Cursor, VS Code i Windsurf
---
...
Rozszerzenie Claude Code jest dostępne bezpośrednio z VS Code marketplace. Wyszukaj „Claude Code" w panelu rozszerzeń. Następnie zainstaluj plugin przez terminal: `claude plugin install seo-machine`.
